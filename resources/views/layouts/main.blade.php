...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/asset/vendor/vector-map/jqvmap.css')}}">
    <link rel="stylesheet" href="{{asset('/asset/vendor/jvectormap/jquery-jvectormap-2.0.2.css')}}">
...
<body>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-rocket"></i>Data Master</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i>Manage Project</a>
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/cards.html"><i class="fas fa-fw fa-table"></i>Plan</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/general.html"><i class="fas fa-fw fa-table"></i>Equipment</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/carousel.html"><i class="fas fa-fw fa-table"></i>Job Description</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/listgroup.html"><i class="fas fa-fw fa-table"></i>Problem</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
    ...
    <script src="{{asset('asset/vendor/charts/chartist-bundle/Chartistjs.js')}}"></script>
    <script src="{{asset('asset/vendor/charts/chartist-bundle/chartist-plugin-threshold.js')}}"></script>
    <!-- chart C3 js -->
    <script src="{{asset('asset/vendor/charts/c3charts/c3.min.js')}}"></script>
    <script src="{{asset('asset/vendor/charts/c3charts/d3-5.4.0.min.js')}}"></script>
    <!-- chartjs js -->
    <script src="{{asset('asset/vendor/charts/charts-bundle/Chart.bundle.js')}}"></script>
    <script src="{{asset('asset/vendor/charts/charts-bundle/chartjs.js')}}"></script>
    <!-- sparkline js -->
    <script src="{{asset('asset/vendor/charts/sparkline/jquery.sparkline.js')}}"></script>
    <!-- dashboard finance js -->
    <script src="{{asset('asset/libs/js/dashboard-finance.js')}}"></script>
    <!-- main js -->
    <script src="{{asset('asset/libs/js/main-js.js')}}"></script>
    <!-- gauge js -->
    <script src="{{asset('asset/vendor/gauge/gauge.min.js')}}"></script>
    <!-- morris js -->
    ...
    <script src="{{asset('asset/vendor/charts/morris-bundle/morrisjs.html')}}"></script>
    <!-- daterangepicker js -->
